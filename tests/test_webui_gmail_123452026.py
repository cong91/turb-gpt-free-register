...
class Gmail123452026WebUiTests(unittest.TestCase):
    ...
    def test_registration_form_exposes_batch_cdk_input(self):
        ...
        self.assertIn("Số bản ghi chưa dùng", source)
        self.assertIn("gmailApiUrlPoolAvailableV2", source)
        self.assertIn("btnUseAllGmailApiUrlV2", source)
        self.assertIn("useAllUnusedGmailApiUrlRecords", source)
        self.assertIn("gmail_api_url_available", source)
