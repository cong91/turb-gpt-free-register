...
from config.email import (
    ...
    BAMBOOMMO_API_KEY,
    BAMBOOMMO_MAIL_TYPE,
    BAMBOOMMO_OTP_MAX_WAIT,
    BAMBOOMMO_POLL_INTERVAL,
    BAMBOOMMO_REQUEST_TIMEOUT,
    BAMBOOMMO_SERVER,
    BAMBOOMMO_SERVICE,
    CLOUDFLARE_API_BASE,
    CLOUDFLARE_API_KEY,
    ...
    EMAIL_API_BASE_URL,
    EMAIL_API_KEY,
    EMAIL_API_POLL_INTERVAL,
    EMAIL_API_REQUEST_TIMEOUT,
    EMAIL_DOMAIN,
    EMAIL_SOURCE,
    ...
    OTPGMAIL_API_BASE,
    OTPGMAIL_API_KEY,
    OTPGMAIL_OTP_MAX_WAIT,
    OTPGMAIL_POLL_INTERVAL,
    OTPGMAIL_REQUEST_TIMEOUT,
    OTPGMAIL_SERVICE_CODE,
...
from config.register import (
    ...
    AUTO_PAY153_FOR_FREE_TRIAL_AFTER_REGISTER,
