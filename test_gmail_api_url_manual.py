...
def test_6_simulate_poll_success(email: str):
    ...
    print("📞 Giả lập API trả về code=0 với OTP=123456")
...
def test_7_simulate_poll_waiting(email: str):
    ...
    print("📞 Giả lập API trả về code=601 (waiting)")
    print("\n💡 Response mô phỏng:")
...
def test_8_simulate_poll_error(email: str):
    ...
    print("📞 Giả lập API trả về code=602 (error/refund)")
    print("\n💡 Response mô phỏng:")
...
def test_10_email_provider_integration():
    ...
    print("🔍 Kiểm tra gmail_api_url trong EMAIL_SOURCE...")
    ...
    print("   ✅ gmail_api_url có trong danh sách" if has_gmail_api_url else "   ❌ gmail_api_url KHÔNG có trong danh sách")
    ...
    if row:
        ...
        print("   ✅ Nhận diện đúng" if is_correct else "   ❌ Nhận diện SAI (expected: gmail_api_url)")
